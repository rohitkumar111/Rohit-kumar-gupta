...
%>
<table class="table">
  <tr><th>#</th><th>UserName</th><th>Password</th><th>Status</th><th>Email</th><th>Name</th></tr>
  <c:forEach items="${list}" var="q">
  <tr><td>${u.getUsername()}</td><td>${u.getPassword()}</td><td>${u.getStatus()}</td><td>${u.getEmail()}</td><td>${u.getName()}</td>
  <td><a href="uud.jsp?id=${u.getId()}">edit</a></td><td><a href="dud.jsp?id=${u.getId()}">delete</a></td></tr>
  </c:forEach>
